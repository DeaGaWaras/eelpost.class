<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hello Students, We Are</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">XI-B</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Welcome to XIB website. <span class="wave">👋🏼</span></p>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://telegra.ph/file/1003f8c4d53ef1f8d7338.jpg">
    </div>
  </main>
</template>
